...
class LantaiController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Lantai'; // Judul Halaman
    protected $subtitle = 'Manajemen data Lantai'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'lantai'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::lantai.index';
    protected $default_form = 'digitalSign::lantai.form';
    ...
    public function __construct()
    {
        ...
        $this->form_filter = [
            'nama' => [
                ...
                1 => [
                    ...
                    [
                        ['Form', 'text'],
                        ['nama', NULL, ['class' => 'form-control', 'id' => 'nama', 'placeholder' => 'Cari nama lantai...']]
                    ]
                ]
            ]
        ];
        ...
        $this->form = [
            ...
            'label' => [
                ...
                [
                    ['Form', 'text'],
                    ['label', NULL, ['class' => 'form-control ', 'id' => 'label', 'placeholder' => 'ex: isikan data di sini']]
                ]
            ],
            'urutan' => [
                'Urutan',
            ...
            'is_aktif' => [
                ...
                [
                    ['Form', 'checkbox'],
                    ['is_aktif', 1, null, ['id' => 'is_aktif', 'class' => 'form-check-input']]
                ]
            ]
        ];
