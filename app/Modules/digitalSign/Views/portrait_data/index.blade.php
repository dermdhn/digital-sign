                                    ...
                                    <tr>
                                        ...
                                        @foreach ($table_columns as $db_col => $tb_col)
                                            <td>
                                                ...
                                                @elseif($db_col == 'gambar_tokoh' && !empty($r->{$db_col}))
                                                    <img src="{{ asset('storage/' . $r->{$db_col}) }}"
                                                        alt="Gambar Tokoh"
                                                        style="height: 60px; object-fit: cover; cursor: zoom-in;"
                                                        class="img-thumbnail"
                                                        onclick="showZoomImage('{{ asset('storage/' . $r->{$db_col}) }}')">
...
{{-- Modal Zoom Image function - ALWAYS INCLUDED --}}
<script>
