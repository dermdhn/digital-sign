...
use App\Modules\digitalSign\Models\ContentsTemplate;


class ContentsTemplateController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Contents Template'; // Judul Halaman
    protected $subtitle = 'Manajemen data Contents Template'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'contents_template'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::contents_template.index';
    protected $default_form = 'digitalSign::contents_template.form';
    ...
    protected $table_columns = [
        'kode_template_detail' => 'Kode Template Detail',
			'type' => 'Type',
			'value' => 'Value',
    ...
    {
        $this->model = new ContentsTemplate;
        ...
        $this->form = [
            'kode_template_detail' => [
					'Kode Template Detail',
					[
						['Form', 'text'],
						['kode_template_detail', NULL, ['class' => 'form-control ', 'id' => 'kode_template_detail', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
				'type' => [
					'Type',
					[
						['Form', 'text'],
						['type', NULL, ['class' => 'form-control ', 'id' => 'type', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
				'value' => [
					'Value',
					[
						['Form', 'text'],
						['value', NULL, ['class' => 'form-control ', 'id' => 'value', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
				'content_id' => [
					'Content Id',
					[
						['Form', 'text'],
						['content_id', NULL, ['class' => 'form-control ', 'id' => 'content_id', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
