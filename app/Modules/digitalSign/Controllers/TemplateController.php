...
use App\Modules\digitalSign\Models\Template;
...
class TemplateController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Template'; // Judul Halaman
    protected $subtitle = 'Manajemen data Template'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'template'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::template.index';
    protected $default_form = 'digitalSign::template.form';
