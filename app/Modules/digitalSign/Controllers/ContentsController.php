...
use App\Modules\digitalSign\Models\Contents;
...
class ContentsController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Contents'; // Judul Halaman
    protected $subtitle = 'Manajemen data Contents'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'contents'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::contents.index';
    protected $default_form = 'digitalSign::contents.form';
