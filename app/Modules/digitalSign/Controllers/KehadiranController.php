...
class KehadiranController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Kehadiran'; // Judul Halaman
    protected $subtitle = 'Manajemen data Kehadiran'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'kehadiran'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::kehadiran.index';
    protected $default_form = 'digitalSign::kehadiran.form';
