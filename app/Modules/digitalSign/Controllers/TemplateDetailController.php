...
use App\Modules\digitalSign\Models\TemplateDetail;
...
class TemplateDetailController extends BaseController
{
    // Model database
    protected $model;
    protected $title = 'Template Detail'; // Judul Halaman
    protected $subtitle = 'Manajemen data Template Detail'; // Subtitle Halaman
    protected $breadcrumbs = [];
    protected $add_title = ''; // Title tambahan jika diperlukan ex. terdapat referensi {(User: <code>$nm_user</code>)}
    protected $base_route = 'template_detail'; // Base route name untuk CRUD {sys_user_role}
    ...
    protected $default_view = 'digitalSign::template_detail.index';
    protected $default_form = 'digitalSign::template_detail.form';
    ...
    public function __construct()
    {
        ...
        $this->form = [
            'kode_template' => [
					...
					[
						['Form', 'text'],
						['kode_template', NULL, ['class' => 'form-control ', 'id' => 'kode_template', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
				...
				'keterangan' => [
					...
					[
						['Form', 'text'],
						['keterangan', NULL, ['class' => 'form-control ', 'id' => 'keterangan', 'placeholder' => 'ex: isikan data di sini']]
					]
				],
