...
<body class="bg-gray-100 h-screen flex items-center justify-center overflow-hidden">
    <div class="w-full h-full bg-white shadow-lg flex flex-col overflow-hidden">
        ...
        <header class="header-gradient flex items-center py-20 px-10 h-[180px] relative overflow-hidden">
            ...
            <div
                class="flex-grow text-8xl font-black text-center leading-none font-poppins relative z-10 text-white tracking-wider">
                <h1 class="header-title text-shadow-lg scale-y-110">SELAMAT DATANG DI<br>UNIVERSITAS NEGERI SEMARANG
                </h1>
                <p class="text-3xl font-bold mt-4 text-white/95 header-subtitle tracking-normal">Kampus UNNES Sekaran,
                    Gunungpati,
